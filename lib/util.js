 ...
 */
exports.bufferToCompactBits2 = function(startingBuff){
    console.log('startingBuff', startingBuff)
    const bigNum = bignum.fromBuffer(startingBuff);
    console.log('bigNum ', bigNum)
    const bigNum2 = BigInt(startingBuff.toString());
...
exports.addressToScript = function(addr){
    const decoded = new Buffer(bs58.decode(addr));

    // console.log('Test buffer', decoded)
    // this.bufferToCompactBits2(decoded)
